document.addEventListener("DOMContentLoaded", function () {
    ...
    let validation = {
        ...
        messages: {
            name: {
                ...
                maxLength:
                    "Ad Soyad alanı en fazla 125 karakterden oluşmalıdır.",
            },
            email: {
            ...
            password: {
                ...
                password:
                    "Parolanız en az bir büyük harfi bir küçük harf, bir sayı ve bir özel karakter içermelidir.",
            },
            password_confirmation: {
                ...
                maxLength:
                    "Parola Tekrarı alanı en fazla 125 karakterden oluşmalıdır.",
                password:
                    "Parola Tekrarınız en az bir büyük harfi bir küçük harf, bir sayı ve bir özel karakter içermelidir.",
    ...
    registerFormInputs.forEach(function (input) {
        input.addEventListener("blur", function (event) {
            ...
            let feedbackList =
                parentElement.querySelectorAll(".invalid-feedback");
            ...
            if (validationRules.hasOwnProperty(elementID)) {
                ...
                for (let fieldKey in validationRules[elementID]) {
                    ...
                    if (
                        ...
                        invalidElementInfo.id =
                            elementID + "-feedback-" + fieldKey;
                        invalidElementInfo.textContent =
                            validationMessages[elementID].required;
                        ...
                        let invalidElementInfo = document.querySelector(
                            "#" + elementID + "-feedback-" + fieldKey
                        );
                    ...
                    if (
                        ...
                        invalidElementInfo.id =
                            elementID + "-feedback-" + fieldKey;
                        invalidElementInfo.textContent =
                            validationMessages[elementID].minLength;
                    ...
                    if (
                        ...
                        invalidElementInfo.id =
                            elementID + "-feedback-" + fieldKey;
                        invalidElementInfo.textContent =
                            validationMessages[elementID].maxLength;
                ...
                if (
                    validationRules[elementID].hasOwnProperty("email") &&
                    ...
                    invalidElementInfo.textContent =
                        validationMessages[elementID].email;
                    ...
                    validationRules[elementID].hasOwnProperty("password") &&
                    ...
                    invalidElementInfo.id = elementID + "-feedback";
                    invalidElementInfo.textContent =
                        validationMessages[elementID].password;
                    ...
                    validationRules[elementID].hasOwnProperty(
                        "compareElementId"
                    ) &&
                    validationRules[elementID].password &&
                    ...
                    if (
                        ...
                        invalidElementInfo.textContent =
                            validationMessages[elementID].compareElementId;
