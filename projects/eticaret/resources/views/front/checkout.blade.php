        ...
        <div class="container shadow p-5">
            <div class="row">
                <div class="col-md-9 order-detail-wrapper">
                    <h6>Siparis Bilgileri</h6>
                    <form action="">
                        <ul class="nav nav-tabs nav-justified">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" aria-current="page" href="#adresBilgileri">Adres
                                    Bilgileri</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" aria-current="page" href="#odemeBilgileri">Odeme
                                    Bilgileri</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="adres">* ADRES
                                            <textarea id="adres" cols="30" rows="5"></textarea>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="odemeBilgileri">
                                <div class="row pt-3">
                                    ...
                                    <div class="col-md-8">
                                        <label for="card-date">* SON KULLANMA TARIHI</label>
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        <label for="cvv">* CVV <i class="bi bi-info-circle" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-title="Arka yuzdeki 3 rakam"></i>
                ...
                <div class="col-md-3 shadow basket-detail shadow py-3">
                    <a href="" class="btn bg-orange text-white w-100 btn-approve-basket">Odeme Yap<i
                    ...
                    <div class="contract shadow p-4 mt-4">
                        ...
                        <div class="">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#contractModal">On
                                Bilgilendirme Kosullarini</a>'ni ve
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#contractModal">Satis
                                Sozlesmesi</a>'ni okudum, onayliyorum.
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="text-wrapper">
                        ...
                        <div class="contracts-text-wrapper">
                            <div class="contract-text mx-auto">
                                ...
                                <p>İşbu Ön Bilgilendirme Formu’nun konusu, Alıcı ve Satıcı arasındaki Sözleşme’ye
                                    ilişkin
                                    Kanun ve Yönetmelik hükümleri uyarınca bilgilendirilmesidir. Ayrıca Yönetmelik
                                    uyarınca
                                    yer verilmesi zorunlu olan hususlar Ön Bilgilendirme Formu’nda yer almaktadır.</p>
                                <p>ALICI, Ön Bilgilendirme Formu ve Sözleşme’ye ilişkin bilgileri üyeliğinin bağlı
                                    olduğu
                                ...
                                <p>Ön Bilgilendirme Formu ve Sözleşme’nin uygulanmasında ve yorumlanmasında aşağıda
                                    yazılı
                                ...
                                <table class="pre-contract-tables">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td class="pre-contract-text-align-left">Bir Mal veya Hizmet’i ticari veya
                                                mesleki
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>5411 sayılı Bankacılık Kanunu uyarınca kurulan lisanslı kuruluşları,
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top"><strong>DSM veya Elektronik Ticaret Aracı
                                                    Hizmet
                                                    Sağlayıcı</strong></td>
                                            <td>:</td>
                                            <td>Oluşturduğu sistem ile Satıcı’nın Ürün/Hizmet’i satışa sunduğu
                                                Platform’u
                                                işleten ve Satıcı adına mesafeli sözleşme kurulmasına aracılık eden DSM
                                                Grup
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>Bir ücret veya menfaat karşılığında yapılan ya da yapılması taahhüt
                                                edilen Ürün
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>Ürün’ün Alıcı’ya ulaştırılmasını, iade süreçlerinde Alıcı’dan alınarak
                                                Satıcı
                                                veya DSM’ye ulaştırılmasını sağlayan anlaşmalı kargo veya lojistik
                                                şirketini,
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>Sözleşme kurulmadan ya da buna karşılık herhangi bir teklif Alıcı
                                                tarafından
                                                kabul edilmeden önce Alıcı’yı Yönetmelik’te belirtilen asgari hususlar
                                                konusunda
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>DSM’ye ait www.trendyol.com adlı internet sitesini ve mobil
                                                uygulamasını,</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Kamu tüzel kişileri de dahil olmak üzere ticari veya mesleki amaçlarla
                                                tüketiciye Ürün/Hizmet sunan ya da Ürün/Hizmet sunanın adına ya da
                                                hesabına
                                        ...
                                        <tr>
                                            <td style="vertical-align:top"><strong>Trendyol Teslimat Noktası</strong>
                                            </td>
                                            <td>:</td>
                                            <td>Alıcı’nın satın aldığı Ürünler’i kolayca teslim alabildiği anlaşmalı
                                                esnaf
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>Alışverişe konu olan taşınır eşya, konut veya tatil amaçlı taşınmaz
                                                mallar ile
                                ...
                                <h3 class="pre-contract-h3">3. <span>ALICI, SATICI VE ELEKTRONİK TİCARET ARACI HİZMET
                                        SAĞLAYICI</span>
                                </h3>
                                ...
                                <table class="distant-contract-all-tables">
                                    <tbody>
                                        <tr>
                                            <td width="200" style="vertical-align:top"><strong>Teslim Edilecek
                                                    Kişi</strong>
                                            </td>
                                            <td>:</td>
                                ...
                                <table class="distant-contract-all-tables">
                                    <tbody>
                                        <tr>
                                            <td width="200" style="vertical-align:top"><strong>Satıcının Ticaret Unvanı
                                                    / Adı ve
                                                    Soyadı</strong></td>
                                            <td>:</td>
                                            <td class="distant-contract-text-align-left">TAMER ELEKTRİK İMALAT SANAYİ VE
                                                TİCARET
                                                LİMİTED ŞİRKETİ
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="vertical-align:top"><strong>Satıcının Mersis Numarası</strong>
                                            </td>
                                            <td>:</td>
                                            <td>0817002865600014</td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top"><strong>Satıcının Vergi Kimlik
                                                    Numarası</strong></td>
                                            <td>:</td>
                                            <td>8170028656</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="vertical-align:top"><strong>Satıcı KEP ve E-posta
                                                    Bilgileri</strong></td>
                                            <td>:</td>
                                ...
                                <table class="distant-contract-all-tables">
                                    <tbody>
                                        <tr>
                                            <td width="200" style="vertical-align:top"><strong>Elektronik Ticaret Aracı
                                                    Hizmet
                                                    Sağlayıcı Unvanı</strong></td>
                                            <td>:</td>
                                            <td class="distant-contract-text-align-left">DSM Grup Danışmanlık İletişim
                                                ve Satış
                                                Ticaret A.Ş.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top"><strong>Elektronik Ticaret Aracı Hizmet
                                                    Sağlayıcı
                                                    Adresi</strong></td>
                                            <td>:</td>
                                            <td>Maslak Mahallesi Saat Sokak Spine Tower No:5 iç kapı:19 Sarıyer İstanbul
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top"><strong>Elektronik Ticaret Aracı Hizmet
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>0 212 331 0 200 telefon numarası üzerinden ve Platform’da yer alan
                                                “Trendyol
                                ...
                                <p><b>4.1.</b> Ürün/Hizmet’in temel özellikleri (türü, miktarı, marka/modeli, rengi,
                                    adedi,
                                ...
                                <p><b>4.2.</b> Ürün/Hizmet karşılığında ödenecek tüm tutarlar (tüm vergiler dahil satış
                                    ...
                                    zamanlı olarak gerçekleştirilen alışverişlerde hak kazanılan toplam indirim tutarı
                                    vb.)
                                ...
                                <div style="margin-bottom:15px">
                                    <table class="pre-contract-main-table pre-contract-tables" style="width:100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Siyah Set Multi-let 6'lı Topraklı Çocuk Korumalı Grup Priz-3 Metre +
                                                    3'lü
                                                    Yonca Fiş-priz
                                                </td>
                                                <td>1</td>
                                ...
                                <table class="pre-contract-tables">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="vertical-align:top"><strong>Kargo Şirketi’ne Teslim
                                                    Süresi**</strong>
                                            </td>
                                            <td>:</td>
                                            <td>2024-02-21</td>
                                ...
                                <p>*Sözleşme ve ilgili mevzuat hükümlerinde yer alan istisnalar
                                    saklıdır.<br>**Belirtilen
                                    süre teslimatın taahhüdü değildir, satıcı tarafından kargo şirketine teslim edilme
                                    süresini ifade eder.</p>
                                <p><b>4.3. </b>SÖZ KONUSU ÜRÜN BEDELİ, “TRENDYOL ALICI GÜVENCESİ” KAPSAMINDA SATICI
                                    ADINA,
                                    DSM TARAFINDAN ALICI’DAN TAHSİL EDİLMEKTEDİR. ALICI MALIN BEDELİNİ DSM'YE ÖDEMEKLE,
                                    ÜRÜN
                                    BEDELİNİ SATICI’YA ÖDEMİŞ SAYILACAK VE BİR DAHA ÖDEME YÜKÜMLÜLÜĞÜ ALTINA
                                    GİRMEYECEKTİR.
                                ...
                                <p><b>4.4. </b>KDV dahil satış fiyatı 45 TL olup, sepette yalnızca bir tane alınabilen
                                    ...
                                    sonunda kullanmamış olduğunuz, kalan haklarınızın geçerliliği sona erecek ve bir
                                    sonraki
                                    aya aktarılamayacaktır. Sepetinizde Trendyol Pass bulunması veya daha önce satın
                                    almış
                                    ...
                                    ilişkin cayma hakkınızı kullanamayacağınız için söz konusu siparişte kullanmış
                                    olduğunuz
                                    Trendyol Pass hakkınız veya Trendyol Pass ücreti tarafınıza iade edilemeyecektir.
                                </p>
                                ...
                                <p><b>5.1.</b> Satıcı, Ürün/Hizmet’i eksiksiz, siparişte belirtilen niteliklere uygun ve
                                    varsa garanti belgeleri, kullanım kılavuzları ile mevzuat gereği Ürün/Hizmet’le
                                    birlikte
                                    teslim etmesi gereken sair bilgi ve belgeler ile teslim etmeyi kabul, beyan ve
                                    taahhüt
                                    eder.</p>
                                <p><b>5.2.</b> Ürün, Alıcı veya Alıcı tarafından belirlenen üçüncü kişiye, taahhüt
                                    edilen
                                    teslim süresi içerisinde ve her halükârda 30 (otuz) günlük yasal süreyi aşmamak
                                    koşulu
                                    ile, Alıcı’nın Platform’da belirtmiş olduğu teslimat adresine Kargo Şirketi
                                    tarafından
                                    teslim edilir. Bu süre içerisinde Satıcı’nın edimini yerine getirmemesi durumunda
                                    Alıcı
                                    Sözleşme'yi feshedebilecektir. Ancak Alıcı’nın isteği veya kişisel ihtiyaçları
                                    doğrultusunda hazırlanan Ürün/Hizmet satışlarında teslim süresi ilgili 30 (otuz)
                                    günü
                                    aşabilecektir. Ayrıca, sipariş durumu “Ön Sipariş” veya “Sipariş Üzerine Üretim”
                                    olarak
                                    ...
                                    Üretim” ya da “Ön Sipariş” statüsünde olan bir Ürün/Hizmet satın aldığında
                                    teslimatın 30
                                ...
                                <p><b>5.4.</b> Alıcı’nın sipariş esnasında Ürün’ü Trendyol Teslimat Noktası’na teslim
                                    ...
                                    günlük yasal süre içerisinde teslim edilecektir. Ürün’ün Trendyol Teslimat
                                    Noktası’na
                                    bırakılmasının ardından Alıcı, seçmiş olduğu teslimat adresi bilgilerinde kayıtlı
                                    olan
                                    telefon numarasına gelen kod ile en geç 3 (üç) gün içerisinde Ürün’ü teslim
                                    alacaktır.
                                </p>
                                ...
                                <p><b>5.6.</b> Alıcı veya Alıcı tarafından belirlenen üçüncü kişinin teslim anında
                                    adreste
                                    bulunmaması durumunda Alıcı'nın Ürün/Hizmet’i geç teslim almasından ve/veya hiç
                                    teslim
                                    almamasından kaynaklanan zararlardan ve giderlerden Satıcı sorumlu değildir.</p>
                                <p><b>5.7.</b> Ürün/Hizmet’in teslimat masrafları aksine bir hüküm yoksa Alıcı’ya
                                    aittir.
                                ...
                                <p><b>5.9.</b> Ürün/Hizmet ediminin yerine getirilmesinin imkansızlaştığı hallerde
                                    ...
                                    olarak veya veri saklayıcısı ile bildirmesi ve varsa teslimat masrafları da dâhil
                                    olmak
                                    üzere tahsil edilen tüm ödemeleri bildirim tarihinden itibaren en geç 14 (ondört)
                                    gün
                                ...
                                <p><b>5.10.</b> Alıcı, Ürün’ü teslim almadan önce muayene edecek; ezik, kırık, ambalajı
                                    ...
                                    Ürün’ün özenle korunması borcu, Alıcı’ya aittir. Cayma hakkı kullanılacaksa
                                    Ürün/Hizmet
                                    kullanılmamalı ve Ürün/Hizmet faturası ve teslim sırasında Alıcı’ya iletilen diğer
                                    tüm
                                    belgeler (örneğin garanti belgesi, kullanım kılavuzu vb.) ile birlikte iade edilmesi
                                    gerekmektedir.</p>
                                <p><b>5.11.</b> Alıcı, Sözleşme konusu bedeli ödemekle yükümlü olup, herhangi bir
                                    nedenle
                                    ...
                                    sebeple Banka tarafından başarısız kodu gönderilen ancak buna rağmen Banka
                                    tarafından
                                ...
                                <p><b>5.12.</b> Alıcı, Ürün’ün teslim edilmesinden sonra Alıcı’ya ait kredi kartının
                                    yetkisiz kişilerce haksız kullanılması sonucunda Sözleşme konusu bedelin ilgili
                                    Banka
                                    tarafından Satıcı’ya ödenmemesi halinde, Alıcı Ürün’ü 3 (üç) gün içerisinde iade
                                    masrafları Alıcı’ya ait olacak şekilde Satıcı’ya iade edeceğini kabul, beyan ve
                                    taahhüt
                                    eder.</p>
                                <p><b>5.13.</b> Sözleşme kapsamında herhangi bir nedenle Alıcı’ya bedel iadesi yapılması
                                    ...
                                    yansıtılmasına ilişkin ortalama sürecin 2 (iki) ile 3 (üç) haftayı bulabileceğini,
                                    bu
                                    tutarın Satıcı tarafından Banka’ya iadesinden sonra Alıcı’nın hesaplarına yansıması
                                    halinin tamamen Banka işlem süreci ile ilgili olduğunu ve olası gecikmelerde
                                    Banka’nın
                                    sorumlu olduğunu ve bunlar için DSM’yi ve Satıcı’yı sorumlu tutamayacağını kabul,
                                    beyan
                                    ve taahhüt eder.</p>
                                <p><b>5.14.</b> Alıcı ile sipariş esnasında kullanılan kredi kartı hamilinin aynı kişi
                                    ...
                                    kimlik ve iletişim bilgilerini, siparişte kullanılan kredi kartının bir önceki aya
                                    ait
                                    ekstresini yahut kart hamilinin Banka’dan kredi kartının kendisine ait olduğuna
                                    ilişkin
                                ...
                                <p><b>5.15.</b> Alıcı Sözleşme konusu bedeli Trendyol Cüzdan aracılığıyla ödemesi ve bu
                                    siparişe ilişkin cayma hakkını kullanması halinde cayma hakkından kaynaklı bedel
                                    iadesi
                                ...
                                <p><b>5.16.</b> Sipariş edilmeyen Ürün/Hizmet’in gönderilmesi durumunda, Alıcı’ya karşı
                                    herhangi bir hak ileri sürülemez. Bu hallerde, Alıcı’nın sessiz kalması ya da söz
                                    konusu
                                    Ürün/Hizmet’i kullanmış olması, sözleşmenin kurulmasına yönelik kabul beyanı olarak
                                    yorumlanamaz.</p>
                                <p><b>5.17.</b> Alıcı’nın sipariş edebileceği Ürün/Hizmet adetlerine Platform’dan
                                    yapılacak
                                    duyurularla kısıt getirilebilir. Alıcı’nın Platform’dan yapılan duyurularda
                                    belirtilen
                                    adedin üzerinde Ürün/Hizmet sipariş etmek istemesi halinde sipariş vermesi
                                    engellenebilecek, siparişi verdikten sonra belirtilen adedin üstünde sipariş
                                    verdiğinin
                                    tespit edilmesi halinde ise belirtilen adedin üstündeki siparişleri iptal
                                    edilebilecek
                                    ve bu halde varsa iptal edilen siparişlere ilişkin teslimat masrafları da dâhil
                                    olmak
                                    ...
                                    siparişlerinin engellenebileceği ve iptal edilebileceğini kabul, beyan ve taahhüt
                                    eder.
                                </p>
                                <p><b>5.18.</b> Satıcı’nın herhangi bir sebeple tedarik edemediği siparişler, Alıcı’nın
                                    ...
                                    gönderilecek olup Sözleşme yeni satıcı ile Alıcı arasında kurulmuş olacaktır. Bu
                                    halde,
                                ...
                                <p><b>5.19.</b> Alıcı tüketici sıfatıyla talep, şikayet ve önerilerini yukarıda yer alan
                                    Satıcı iletişim bilgilerini kullanmak suretiyle ve/veya Platform’un sağladığı
                                    kanallarla
                                ...
                                <p><b>6.1.</b> Alıcı, aksi belirtilmedikçe, Platform’da birden fazla butikten tek bir
                                    sepette alışveriş yapabilecektir. Aynı sepet içerisinde farklı butikten alınan her
                                    bir
                                    Ürün/Hizmet için Satıcı tarafından birden fazla fatura kesilebilecektir. Şüpheye
                                    mahal
                                    bırakmamak bakımından belirtilmelidir ki, Satıcı, Alıcı’nın farklı butiklerden
                                    aldığı
                                    Ürün/Hizmet’in teslimatını mevzuattaki yasal süre içerisinde kalmak koşuluyla farklı
                                    zamanlarda gerçekleştirebilecektir.</p>
                                <p><b>6.2.</b> Alıcı’nın vereceği siparişlerde kurumsal fatura seçeneğini seçmesi
                                    durumunda
                                    Satıcı, Alıcı tarafından Platform üzerinden bildirilecek vergi kimlik numarası ve
                                    vergi
                                    dairesi bilgilerini kullanarak kurumsal fatura düzenleyecektir. Faturada yer alması
                                    gereken bilgilerin doğru, güncel ve eksiksiz girilmesi tamamen Alıcı’nın
                                    sorumluluğunda
                                    olup, bu sebeple doğabilecek tüm zararlardan bizzat Alıcı sorumludur.</p>
                                <p><b>6.3.</b> Platform üzerinden kredi kart ile ödeme yapılması halinde, Banka
                                    tarafından
                                    kampanyalar düzenlenerek Alıcı tarafından seçilen taksit adedinin daha üstünde bir
                                    taksit adedi uygulanabilecek veya taksit erteleme gibi ek hizmetler
                                    sunulabilecektir. Bu
                                    tür kampanyalar Banka’nın inisiyatifindedir. Alıcı’nın kredi kartının hesap kesim
                                    tarihinden itibaren sipariş toplamı taksit adedine bölünerek kredi kartı özetine
                                    Banka
                                    tarafından yansıtılacaktır. Banka taksit tutarlarını küsurat farklarını dikkate
                                    alarak
                                    aylara eşit olarak dağıtmayabilir. Detaylı ödeme planlarının oluşturulması Banka’nın
                                    inisiyatifindedir.</p>
                                <p><b>6.4.</b> Dijital ürünler fiziki gönderime uygun olmayıp, teslimat ürün niteliğine
                                    göre
                                    şartlarında belirtilen şekilde gerçekleştirilecektir. Sözleşme’nin yer alıp da
                                    teslimat
                                    ...
                                    şartlarında belirtilen koşul ve açıklamalara uygun olacak şeklinde yorumlanmalıdır.
                                </p>
                                ...
                                <p><b>6.6.</b> Platformda satışa sunulan Ürün/Hizmetler yalnızca Satıcı tarafından
                                    ...
                                    sunulabilecek olup, sipariş sürecinde Alıcı'nın bu ürün/hizmetler için teslimat
                                    adresini
                                    Satıcı tarafından belirlenmiş olan lokasyonlardan biri dışında seçmesi halinde
                                    ilgili
                                    sipariş verilemeyecek/satın alım gerçekleşmeyecektir.</p>
                                <p><b>6.7.</b>Türkiye Cumhuriyeti resmi kamu kurum ve kuruluşları ile koordineli
                                    yürütülen
                                    "Depreme Yardım Seferberliği" ve benzeri seferberlik ve yardım işlemleriyle
                                    bağlantılı
                                    siparişlerde (ö: koli yardımı, vb.), Mesafeli Sözleşmeler Yönetmeliği’nin 15/1-h
                                    maddesi
                                    gereği cayma hakkı kullanılamayacaktır.</p>
                                <h3 class="pre-contract-h3">7.
                                    <span>KİŞİSEL VERİLERİN KORUNMASI VE FİKRİ-SINAİ HAKLAR</span>
                                </h3>
                                <p><b>7.1.</b> Satıcı, işbu sözleşme kapsamındaki kişisel verileri sadece Ürün/Hizmet’in
                                    ...
                                    işleyecektir. Satıcı, Platform üzerinden eriştiği kişisel veriler haricinde
                                    Alıcı’nın
                                    kişisel verilerini işlemeyeceğini ve Platform üzerinden sağlanan yöntemler dışında
                                    Alıcı
                                    ile harici olarak iletişime geçmeyeceğini kabul, beyan ve taahhüt eder.</p>
                                <p><b>7.2.</b> Alıcı, işbu Sözleşme kapsamında sağladığı kişisel verilerin doğru,
                                    eksiksiz
                                    ve güncel olduğunu kontrol etmekle, bu bilgileri üçüncü kişilerle paylaşmamak,
                                    ilgisiz
                                    kişilerce erişilememesi için virüs ve benzeri zararlı uygulamalara ilişkin olanlar
                                    dahil
                                    gerekli tedbirleri almak ve söz konusu kişisel verilerin güvenliğini sağlamakla
                                    yükümlü
                                    olduğunu, aksi halde doğacak zararlardan ve üçüncü kişilerden gelen taleplerden
                                    bizzat
                                    sorumlu olduğunu kabul, beyan ve taahhüt eder.</p>
                                <p><b>7.3.</b> Platform’a ait her türlü bilgi ve içerik ile bunların düzenlenmesi,
                                    revizyonu
                                    ve kısmen/tamamen kullanımı konusunda; Satıcı'nın anlaşmasına göre diğer üçüncü
                                    şahıslara ait olanlar hariç; tüm fikri-sınai haklar ve mülkiyet hakları DSM’ye
                                    aittir.
                                </p>
                                ...
                                <p><b>8.2.</b> Cayma hakkı süresi, Hizmet için Sözleşme’nin kurulduğu gün; Ürün için
                                    ...
                                    başlar. Ancak Alıcı, Sözleşme’nin kurulmasından Ürün teslimine kadar olan süre
                                    içinde de
                                ...
                                <p><b>b)</b> Birden fazla parçadan oluşan Ürün’de, Alıcı veya Alıcı tarafından
                                    belirlenen
                                    üçüncü kişinin son parçayı teslim aldığı gün,</p>
                                <p><b>c)</b> Belirli bir süre boyunca Ürün’ün düzenli tesliminin yapıldığı durumlarda,
                                    Alıcı
                                    veya Alıcı tarafından belirlenen üçüncü kişinin ilk Ürün’ü teslim aldığı gün</p>
                                <p>esas alınır.</p>
                                <p><b>8.4.</b> Ürün teslimi ile Hizmet ifasının birlikte olduğu durumlarda, Ürün
                                    teslimine
                                    ilişkin cayma hakkı hükümleri uygulanır.</p>
                                <p><b>8.5.</b> Satıcı;</p>
                                <p><b>a)</b> Ürün'ün teslimi veya Hizmet’in ifasından önce Alıcı’nın cayma hakkını
                                    kullanması durumunda cayma hakkının kullanıldığına ilişkin bildirimin kendisine
                                    ulaştığı
                                    tarihten itibaren,</p>
                                <p><b>b)</b> Ürün’ün tesliminden sonra Alıcı’nın cayma hakkını kullanması durumunda,
                                    cayma
                                    bildiriminin kendisine ulaştığı tarih itibarıyla bedel Satıcı’ya aktarılmamışsa
                                    cayma
                                    hakkına konu Ürün’ün, iade için öngörülen Kargo Şirketi’ne teslim edildiği tarihten
                                    veya
                                ...
                                <p><b>c)</b> Alıcı’nın siparişinin yasal süre içerisinde teslim edilememesi nedeniyle
                                    ...
                                    tarihten itibaren</p>
                                <p>15 (onbeş) gün içinde, tahsil ettiği Sözleşme konusu bedeli ile teslimat
                                    masraflarının
                                    Alıcı’ya iadesinden sorumludur.</p>
                                <p><b>8.6.</b> Cayma hakkı bildiriminin ve Sözleşme’ye ilişkin diğer bildirimlerin
                                    mevzuata
                                    uygun ve süresi içerisinde Platform’da belirtilen DSM’ye ve/veya Satıcı’ya ait
                                    iletişim
                                ...
                                <p><b>a)</b> Alıcı cayma hakkını kullanmasından itibaren 14 (ondört) gün içerisinde
                                    Ürün’ü
                                ...
                                <p><b>b)</b> Cayma hakkı kapsamında iade edilecek Ürün kutusu, ambalajı, varsa standart
                                    aksesuarları ve varsa Ürün ile birlikte hediye edilen diğer Ürünler’in de eksiksiz
                                    ve
                                ...
                                <p><b>8.8.</b> Alıcı cayma süresi içinde Ürün’ü, işleyişine, teknik özelliklerine ve
                                    kullanım talimatlarına uygun bir şekilde kullandığı takdirde meydana gelen
                                    değişiklik ve
                                    bozulmalardan sorumlu değildir.</p>
                                <p><b>8.9.</b> Cayma hakkının kullanılmasını takip eden 14 (ondört) gün içerisinde
                                    Sözleşme
                                    konusu bedeller Alıcı’ya Alıcı’nın ödeme yöntemi ile iade edilmektedir. Ürün/Hizmet,
                                    Satıcı'ya iade edilirken, Ürün/Hizmet’in teslimi sırasında Alıcı’ya ibraz edilmiş
                                    olan
                                    orijinal faturanın da Alıcı tarafından iade edilmesi gerekmektedir. Alıcı’nın
                                    kurumsal
                                ...
                                <p><b>8.10.</b> Alıcı iade edeceği Ürün/Hizmet’i Ön Bilgilendirme Formu’nda belirtilen
                                    ...
                                    aittir. İade için Alıcı’nın bulunduğu yerde Satıcı’nın Kargo Şirketi şubesi
                                    bulunmaması
                                    halinde, Alıcı Ürün’ü herhangi bir Kargo Şirketi’yle gönderebilecektir. Bu halde
                                    iade
                                ...
                                <p><b>b) </b>Tüketicinin istekleri veya kişisel ihtiyaçları doğrultusunda hazırlanan
                                    mallara
                                    ilişkin sözleşmeler,</p>
                                <p><b>c) </b>Çabuk bozulabilen veya son kullanma tarihi geçebilecek malların teslimine
                                    ilişkin sözleşmeler,</p>
                                <p><b>d)</b> Tesliminden sonra ambalaj, bant, mühür, paket gibi koruyucu unsurları
                                    açılmış
                                    olan mallardan; iadesi sağlık ve hijyen açısından uygun olmayanların teslimine
                                    ilişkin
                                    sözleşmeler,</p>
                                ...
                                <p><b>g)</b>Abonelik sözleşmesi kapsamında sağlananlar dışında gazete ve dergi gibi
                                    süreli
                                ...
                                <p><b>h)</b>Belirli bir tarihte veya dönemde yapılması gereken, konaklama, eşya taşıma,
                                    araba kiralama, yiyecek içecek tedariki ve eğlence veya dinlenme amacıyla yapılan
                                    boş
                                ...
                                <p>cayma hakkı kullanılamayacak; bu siparişler bakımından Platform üzerinden iade kodu
                                    da
                                    oluşturulamayacaktır.</p>
                                <p><b>9.2.</b> Ürün/Hizmet’in Yönetmelik'in uygulama alanı dışında bırakılmış olan
                                    <i>(Sözleşme’nin
                                        3.3. maddesinde listelenmiştir)</i> Ürün/Hizmet türlerinden müteşekkil olması
                                    halinde
                                    Alıcı ve Satıcı arasındaki hukuki ilişkiye Yönetmelik hükümleri uygulanamaması
                                    sebebiyle
                                    cayma hakkı kullanılamayacak; bu siparişler bakımından Platform üzerinden iade kodu
                                    da
                                ...
                                <p><b>10.1</b>Sözleşme’nin uygulanmasında, Bakanlık’ça ilan edilen değerlere uygun
                                    olarak
                                    Alıcı’nın Ürün/Hizmet’i satın aldığı ve ikametgahının bulunduğu yerdeki Tüketici
                                    Hakem
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="200" style="vertical-align:top"><strong>Satıcının Ticaret Unvanı
                                                    ...
                                                    Soyadı</strong></td>
                                            <td>:</td>
                                            <td class="distant-contract-text-align-left">TNS BİLİŞİM ELEKTRONİK SANAYİ
                                                VE DIŞ
                ...
                <div class="modal-footer">
                    <button type="button"
                        class="btn bg-orange text-white w-100 btn-contracts-approve">Onaylıyorum</button>
                </div>
            </div>
        </div>
    </div>
