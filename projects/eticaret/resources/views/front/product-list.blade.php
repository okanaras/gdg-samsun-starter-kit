                                    ...
                                    <div class="filter-detail">
                                        <div class="filter-item">
                                            <div class="row filter-price">
                                                <div class="col">
                                                    <input type="text" class="min-price form-control"
                                                        placeholder="En az">
                                                </div>
                                                <div class="col">
                                                    <input type="text" class="max-price form-control"
                                                        placeholder="En cok">
                                                </div>
                                                <div class="col-3">
                                                    <button type="submit">
                        ...
                        <div class="row products mt-4 p-4">
                            <div class="col-md-3 wrapper-product position-relative mb-5">
                                <div class="product-image position-relative">
                                    <a href="">
                                        <img src="{{ asset('assets/images/product4.jpeg') }}" class="img-fluid"
                                            alt="adidas">
                                    </a>
