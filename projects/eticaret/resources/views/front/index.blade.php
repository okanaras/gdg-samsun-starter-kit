...
@section('body')
                ...
                <div class="swiper-slide">
                    ...
                    <div class="slider-title">
                        <div class="title-wrapper">
                            <h3 class="font-playfair fw-bold-600">SEPETTE %30 INDIRIM</h3>
                            <h2 class="fw-bold-600 text-white">KACIRMA</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative">
                    <h3 class="fw-bold-600">Markalarimiz</h3>
                    ...
                    <div class="brand-swiper mt-4">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide text-center">
                                <div class="brand-slider">
                                    <a href="">
                                        <img src="{{ asset('assets/images/brand4.webp') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide text-center">
    ...
    <section class="feature-product-banner positon-relative mt-5">
        <div class="col-12">
    ...
    <section class="feature-season-brands position-relative my-5 py-5">
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative">
                    <h3 class="fw-bold-600">Sezonun One Cikanlari</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="wrapper-product position-relative">
                                    <div class="product-image position-relative">
                                        <a href="">
                                            <img src="{{ asset('assets/images/product1.jpeg') }}" class="img-fluid"
                                                alt="adidas">
                                        </a>
                                        <div class="product-overlay">
                                            ...
                                            <a href="" class="product-brand text-orange fw-bold-600">Adidas</a>
                                        </div>
                                    </div>
                                    <div class="product-info text-center pt-3">
                                        ...
                                        <a href="" class="product-price text-orange">1.299.00 TL</a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
