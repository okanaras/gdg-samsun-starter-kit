        ...
        <div class="container shadow p-5">
            <div class="row">
                ...
                <div class="col-md-3 shadow basket-detail shadow py-3">
                    <a href="" class="btn bg-orange text-white w-100 btn-approve-basket">Sepeti Onayla<i
                    ...
                    <div class="discount-wrapper mt-4">
                        <h5 class="text-orange">INDIRIM KODU</h5>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Indirim Kodu Gir">
