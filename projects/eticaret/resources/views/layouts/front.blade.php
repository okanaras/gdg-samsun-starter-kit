    ...
    <div class="top-bar bg-black">
        <div class="container">
            <div class="login float-end">
                <ul class="login-list">
                    <li><a href="" class="text-white">GIRIS</a></li>
                    ...
                    <li class="dropdown user-basket">
                        <a href="javascript:void(0)" class="dropdown-toggle position-relative" role="button"
                            ...
                            <i class="bi bi-cart text-white fs-4 zoom"></i>
                                ...
                                <div class="col-12">
                                    <div class="card border-0">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">Urun Basligi</h5>
                            ...
                            <div class="row total-price">
                                ...
                                <div class="col-12 basket-buttons">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a href="" class="btn btn-outline-success w-100">Odeme</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
